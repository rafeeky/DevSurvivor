...
window.CHAR_CONFIGS = {
  ...
  amelia: {
    ...
    idle: { src: 'assets/custom/player/twiggy_idle.png', fw: 32, fh: 32, frames: 5, fps: 6 },
    walk: { src: 'assets/custom/player/twiggy_walk.png', fw: 32, fh: 32, frames: 6, fps: 10 },
    hit:  { src: 'assets/custom/player/twiggy_hit.png',  fw: 32, fh: 32, frames: 3, fps: 8 },
    scale: 3,
    yAnchor: 0.75,
  },
}
