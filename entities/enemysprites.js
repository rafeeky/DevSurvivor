 ...
 * v0.7 확정 매핑:
 *   BoxBot   (1st) = assets/custom/enemies/boxbot.png  (RGBA 단일 프레임)
 *   CartBot  (2nd) = Gum Bot   (sprite-pack-3/1)
 *   PCBot    (3rd) = Robot J5  (sprite-pack-3/3)
 *   MirrorBot(4th) = Geralt    (sprite-pack-3/5)
 *   AIBot    (5th) = Tommy     (sprite-pack-3/4) + 붉은 외곽선 (enemies.js)
 */

window.ENEMY_SPRITE_CONFIGS = {
  BoxBot: {
    idle: { src: 'assets/custom/enemies/boxbot.png', fw: 1024, fh: 1024, frames: 1, fps: 1 },
    walk: { src: 'assets/custom/enemies/boxbot.png', fw: 1024, fh: 1024, frames: 1, fps: 1 },
    scale: 0.08,
  },
  CartBot: {
