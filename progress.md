...
### Milli 호출 필요 — GDD 수치 동기화

구현된 수치가 GDD 원문과 일부 다름. Milli가 GDD.md를 업데이트해야 함.

| 항목 | GDD 원문 | 구현 수치 | 비고 |
|------|---------|---------|------|
| 커피 한 잔 쿨다운 | 14초 | 20초 | 밸런스 조정으로 변경 |
| 피규어 청소하기 쿨다운 | 16초 | 12초 | 밸런스 조정으로 변경 |
| 피규어 청소하기 넉백 범위 | 100px | 150px | 확장 |
| 우선순위 정리 부채꼴 각도 | 90° | 120° | 확장 |
| 낮잠자기 쿨다운 -3초 효과 | 명시됨 | 미구현 | 추후 levelup.js에서 처리 |
